...
const plans = [
  { name: 'Starter', price: '₹499', featured: false, desc: 'For students who need a quick, visible boost before applications open.',
  ...
  { name: 'Builder', price: '₹899', featured: true, desc: 'The internship-season special. Used by 60% of our clients.',
  ...
  { name: 'Pro', price: '₹1,299', featured: false, desc: 'Complete transformation. Used by final-year students and early founders.',
